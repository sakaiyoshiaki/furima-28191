...
describe Item do
  describe '#create' do
    ...
    it '全て入力されていればOK' do   # Userを入力してください
    ...
    #   @item.valid?
    #   expect(@item.errors[:shipping_charges_id]).to include("は1以外の値にしてください")
    # end
    # it "from_area_idが1ならNG" do
    #   @item.from_area_id = "1"
    #   @item.valid?
    #   expect(@item.errors[:from_area_id]).to include("は1以外の値にしてください")
    # end
    # it "deliver_leadtime_idが1ならNG" do
    #   @item.deliver_leadtime_id = "1"
    #   @item.valid?
    #   expect(@item.errors[:deliver_leadtime_id]).to include("は1以外の値にしてください")
    # end
