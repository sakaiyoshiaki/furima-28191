...
ActiveRecord::Schema.define(version: 2020_12_14_120037) do
  ...
  create_table "orders", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["item_purchase_id"], name: "index_orders_on_item_purchase_id"
  end
  ...
  create_table "users", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4", force: :cascade do |t|
    ...
    t.string "personal_name", default: "", null: false
    t.string "family_name_kana", default: "", null: false
    t.string "personal_name_kana", default: "", null: false
  ...
  add_foreign_key "orders", "item_purchases"
end
